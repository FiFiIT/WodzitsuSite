...
namespace WodzitsuSite.Migrations
{
    ...
    [Migration("20190325133815_TourScores")]
    partial class TourScores
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WodzitsuSite.Data.Entities.Czlopok", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("WodzitsuSite.Data.Entities.Czlopok")
                        .WithMany()
            ...
            modelBuilder.Entity("WodzitsuSite.Data.Entities.Czlopok", b =>
                {
                    b.HasOne("WodzitsuSite.Data.Entities.TourScore")
                        .WithMany("UserId")
                        .HasForeignKey("TourScoreId");
                });
